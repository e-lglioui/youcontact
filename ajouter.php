...
if(isset($_POST['submit'])){
  ...
  $sql = "INSERT INTO `contact` (nom, prenom, email, tel,adress) VALUES ('$nom', '$prenom', '$email', '$tel','$adress')";
 ...
 <form method="post" name="/registrationForm" onsubmit="validateForm(event)">
   ...
   <div class="flex -mx-3">
    <div class="w-full px-3 mb-5">
        ...
        <div class="flex">
            <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-email-outline text-gray-400 text-lg"></i></div>
            <input type="text" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Enter your numbre tel" name="tel" autocomplete="off">
        </div>
   ...
   <div class="flex -mx-3">
    <div class="w-full px-3 mb-5">
        ...
        <div class="flex">
            <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-email-outline text-gray-400 text-lg"></i></div>
            <input type="text" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="adresse" name="adresse" autocomplete="off">
        </div>
        <span id="télephonError" class="text-red-500"></span>
    </div>
  </div>
